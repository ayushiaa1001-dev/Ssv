    ...
    <section className="about" id="about" ref={ref}>
      <div className={`about__inner container ${visible ? 'about--visible' : ''}`}>
        <div className="about__content">
          ...
          <p className="about__text">
            Our commitment to <strong>Synergy, System & Values</strong>, along with stringent quality controls and a patient-centric approach, has earned us the trust of healthcare professionals and patients across India.
          </p>
        </div>
